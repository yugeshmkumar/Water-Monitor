...
struct DeviceConfig: Equatable {
    var wifiSSID: String = ""
    var wifiPass: String = ""
    var tankEmptyMM: Double = 1500     // Empty distance in millimeters (not CM)
    var tankFullMM: Double = 200       // Full distance in millimeters (not CM)
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case tankEmptyMM = "tank_empty_mm"
        case tankFullMM = "tank_full_mm"
    ...
    func patch(from edited: DeviceConfig) -> [String: Any] {
        ...
        if edited.tankEmptyMM           != tankEmptyMM           { diff["tank_empty_mm"]              = edited.tankEmptyMM }
        if edited.tankFullMM            != tankFullMM            { diff["tank_full_mm"]               = edited.tankFullMM }
...
extension DeviceConfig: Codable {
    init(from decoder: Decoder) throws {
        ...
        tankEmptyMM = try container.decodeIfPresent(Double.self, forKey: .tankEmptyMM) ?? 1500
        tankFullMM = try container.decodeIfPresent(Double.self, forKey: .tankFullMM) ?? 200
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(tankEmptyMM, forKey: .tankEmptyMM)
        try container.encode(tankFullMM, forKey: .tankFullMM)
